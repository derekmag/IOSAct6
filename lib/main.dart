...
class DerekApp extends StatefulWidget {
  @override
  _DerekAppState createState() => _DerekAppState();
}

class _DerekAppState extends State<DerekApp> {
  @override
...
class _PrincipalState extends State<Principal> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Centro de computo Derek"),
        centerTitle: true,
